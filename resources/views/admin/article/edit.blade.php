...
<script type="importmap">{
 ...
 <div class="page-content fade-in-up">
     <div class="row">
         <div class="col-md-12">
             <div class="ibox">
                 <div class="ibox-head">
                     <div class="ibox-title">Edit Article</div>
                 ...
                 <div class="ibox-body">
                     ...
                     <form action="{{ route('admin.article.update', $article->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation form-horizontal" id="update_article" novalidate>
 ...
 <script type="text/javascript">
     ...
     $(document).ready(function() {
        ...
        var count = {{count($article->author)}};
        count = count+1;
        @else 
         var count = 1;
        @endif
     ...
     $(document).ready(function() {
        @if(isset($article->affiliation) and count($article->affiliation) > 0)
         var fcount = {{count($article->affiliation)}};
         fcount = fcount+1;
        @else 
         var fcount = 1;
        @endif
        ...
        function dynamic_aff(numb) {
            ...
            html += '<td><input type="text" name="inst_address[]" placeholder="Instaddress" class="form-control" style="margin-bottom:4px">';
            html += '<input type = "text" name = "inst_name[]" placeholder = "Instname" class = "form-control"></td>';
            html += '<td><input type="text" name="inst_city[]" placeholder="instcity" class="form-control" style="margin-bottom:4px">';
            ...
            html += ' <input type = "text" name = "inst_tel[]" placeholder = "Telno" class = "form-control"> </td>';
