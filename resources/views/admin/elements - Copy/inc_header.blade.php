...
<head>
    ...
    <style>
        ...
        .page-heading .page-title { margin: 10px 0 10px 0; }
                ...
                <ul class="nav navbar-toolbar">
                            ...
                            <li class="list-group list-group-divider scroller" data-height="240px" data-color="#71808f">
                                <div>
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="{{ url('/')}}/admin_assets/img/users/u1.jpg" />
                                            </div>
                                    ...
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="{{ url('/')}}/admin_assets/img/users/u2.jpg" />
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="{{ url('/')}}/admin_assets/img/users/u3.jpg" />
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="{{ url('/')}}/admin_assets/img/users/u4.jpg" />
                                            </div>
                                            <div class="media-body">
                    ...
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="{{url('')}}/manage/login/logout"><i class="fa fa-power-off"></i>Logout</a>
                        </ul>
                    </li>
                </ul>
