...
<div class="row">
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item"><a href="{{url('/')}}/admin/pages/">Pages List</a></li>
		<li class="breadcrumb-item"><a href="#">Edit Page</a></li>

		<li class="breadcrumb-menu">
			<ul style="list-style-type: none;">
				<li> <a class="btn btn-outline-primary" href="{{url('/')}}/admin/pages/"><i class="fa fa-undo"></i> Back</a></li>
			</ul>
		</li>
	</ol>
</div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="ibox">
				...
				<div class="ibox-body">
					<form action="{{ route('admin.pages.update', $page->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation form-horizontal" id="create_page" novalidate>
						@csrf
						@method('PATCH')
