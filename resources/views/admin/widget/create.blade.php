...
<div class="row">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Add Widget</a></li>
...
<div class="page-content fade-in-up">
    <div class="row">
        <div class="col-md-12">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Add Widget</div>
                ...
                <form action="{{ route('admin.widget.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation form-horizontal" id="create_widget" novalidate>
						@csrf
						@method('POST')
